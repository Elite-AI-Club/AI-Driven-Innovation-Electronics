...
class ObjectCounter:
    def __init__(self, line_position=0.5):
        ...
        # Initialize webcam
        self.capture = cv2.VideoCapture(0)  # Use 0 for default webcam, or try 1,2,etc for other cameras
        ...
        # Set up video writer
        self.output_path = 'webcam_counted.mp4'
...
def main():
    try:
        # Initialize and run counter with webcam
